...
parser.add_argument('--scenario', type=str, default='22')
...
# Fitness is now created out of losses since it seems to be slightly off int the above graphs


if args.scenario == "22":
    scena = '2_points_2_predators'
    POF = [[0.7 , 0.79365079],
        [2.5, 0.222222222]]
elif args.scenario == "25":
    scena = '2_points_5_predators'
    POF = [[0.7 , 0.79365079],
        [2.5, 0.222222222]]
elif args.scenario == "52":
    scena = '5_points_2_predators'
    POF = [[0.7   , 0.79365079],
    [1.05  , 0.52910053],
    [1.45  , 0.38314176],
    [1.9   , 0.29239766],
...
plt.plot(0.8540317087443834,0.2311142641705336,'s', color='k' ,label='clean MT-DNN')


# Define the start and end colors (in RGB)
start_color = (1, 0, 0.5)  # Deep Pink
end_color = (1, 0.75, 0.8)  # Pink

# Create a list of 5 colors using a gradient between start and end colors
deeppink_colors = [(r, g, b) for r, g, b in zip(np.linspace(start_color[0], end_color[0], 5),
                                                 np.linspace(start_color[1], end_color[1], 5),
                                                 np.linspace(start_color[2], end_color[2], 5))]


# for zdepth, normal in zip(results['WGD']['1']['zdepth'],results['WGD']['1']['normal']):
fitness = fitness_evaluation_validation(results['WGD']['1']['zdepth'],results['WGD']['1']['normal'],A)
print("WGD 1: ",fitness)
plt.plot(results['WGD']['1']['zdepth'],results['WGD']['1']['normal'],'o', color=deeppink_colors[-1] ,label='WGD (1 step)')

fitness = fitness_evaluation_validation(results['WGD']['2']['zdepth'],results['WGD']['2']['normal'],A)
print("WGD 2: ",fitness)
plt.plot(results['WGD']['2']['zdepth'],results['WGD']['2']['normal'],'o', color=deeppink_colors[-2] ,label='WGD (2 steps)')

fitness = fitness_evaluation_validation(results['WGD']['4']['zdepth'],results['WGD']['4']['normal'],A)
print("WGD 4: ",fitness)
plt.plot(results['WGD']['4']['zdepth'],results['WGD']['4']['normal'],'o', color=deeppink_colors[-3] ,label='WGD (4 steps)')

fitness = fitness_evaluation_validation(results['WGD']['10']['zdepth'],results['WGD']['10']['normal'],A)
print("WGD 10: ",fitness)
plt.plot(results['WGD']['10']['zdepth'],results['WGD']['10']['normal'],'o', color=deeppink_colors[-4] ,label='WGD (10 steps)')

fitness = fitness_evaluation_validation(results['WGD']['20']['zdepth'],results['WGD']['20']['normal'],A)
print("WGD 20: ",fitness)
plt.plot(results['WGD']['20']['zdepth'],results['WGD']['20']['normal'],'o', color=deeppink_colors[-5] ,label='WGD (20 steps)')
...
# Create a list of 5 colors using a gradient between start and end colors
orange_colors = [(r, g, b) for r, g, b in zip(np.linspace(start_color[0], end_color[0], 5),
                                                 np.linspace(start_color[1], end_color[1], 5),
                                                 np.linspace(start_color[2], end_color[2], 5))]


fitness = fitness_evaluation_validation(results['MI-PGD']['1']['zdepth'],results['MI-PGD']['1']['normal'],A)
print("MI-PGD 1: ",fitness)
plt.plot(results['MI-PGD']['1']['zdepth'],results['MI-PGD']['1']['normal'],'^', color=orange_colors[-1] ,label='MI-PGD (1 step)')

fitness = fitness_evaluation_validation(results['MI-PGD']['2']['zdepth'],results['MI-PGD']['2']['normal'],A)
print("MI-PGD 2: ",fitness)
plt.plot(results['MI-PGD']['2']['zdepth'],results['MI-PGD']['2']['normal'],'^', color=orange_colors[-2] ,label='MI-PGD (2 steps)')

fitness = fitness_evaluation_validation(results['MI-PGD']['4']['zdepth'],results['MI-PGD']['4']['normal'],A)
print("MI-PGD 4: ",fitness)
plt.plot(results['MI-PGD']['4']['zdepth'],results['MI-PGD']['4']['normal'],'^', color=orange_colors[-3] ,label='MI-PGD (4 steps)')

fitness = fitness_evaluation_validation(results['MI-PGD']['10']['zdepth'],results['MI-PGD']['10']['normal'],A)
print("MI-PGD 10: ",fitness)
plt.plot(results['MI-PGD']['10']['zdepth'],results['MI-PGD']['10']['normal'],'^', color=orange_colors[-4] ,label='MI-PGD (10 steps)')

fitness = fitness_evaluation_validation(results['MI-PGD']['20']['zdepth'],results['MI-PGD']['20']['normal'],A)
print("MI-PGD 20: ",fitness)
plt.plot(results['MI-PGD']['20']['zdepth'],results['MI-PGD']['20']['normal'],'^', color=orange_colors[-5] ,label='MI-PGD (20 steps)')



# Define the start and end colors (in RGB)
start_color = (0.8, 0.6, 1)
end_color = (0.5, 0, 1)

# Create a list of 5 colors using a gradient between start and end colors
gradient_colors = [(r, g, b) for r, g, b in zip(np.linspace(start_color[0], end_color[0], 5),
                                                 np.linspace(start_color[1], end_color[1], 5),
                                                 np.linspace(start_color[2], end_color[2], 5))]


print("gradient color list os of size:", len(gradient_colors))

fitness = fitness_evaluation_validation(results['PGD']['1']['zdepth'],results['PGD']['1']['normal'],A)
print("PGD 1: ",fitness)
plt.plot(results['PGD']['1']['zdepth'],results['PGD']['1']['normal'],'p', color=gradient_colors[0] ,label='PGD (1 step)')

fitness = fitness_evaluation_validation(results['PGD']['2']['zdepth'],results['PGD']['2']['normal'],A)
print("PGD 2: ",fitness)
plt.plot(results['PGD']['2']['zdepth'],results['PGD']['2']['normal'],'p', color=gradient_colors[1] ,label='PGD (2 steps)')

fitness = fitness_evaluation_validation(results['PGD']['4']['zdepth'],results['PGD']['4']['normal'],A)
print("PGD 4: ",fitness)
plt.plot(results['PGD']['4']['zdepth'],results['PGD']['4']['normal'],'p', color=gradient_colors[2] ,label='PGD (4 steps)')

fitness = fitness_evaluation_validation(results['PGD']['10']['zdepth'],results['PGD']['10']['normal'],A)
print("PGD 10: ",fitness)
plt.plot(results['PGD']['10']['zdepth'],results['PGD']['10']['normal'],'p', color=gradient_colors[3] ,label='PGD (10 steps)')

fitness = fitness_evaluation_validation(results['PGD']['20']['zdepth'],results['PGD']['20']['normal'],A)
print("PGD 20: ",fitness)
plt.plot(results['PGD']['20']['zdepth'],results['PGD']['20']['normal'],'p', color=gradient_colors[4] ,label='PGD (20 steps)')
...
# find the best distance of each model and plot it
fitness=[]
for zdepth, normal in zip(loss_results['test_results'][scena]['antipodes-non-greedy']['zdepth'],loss_results['test_results'][scena]['antipodes-non-greedy']['normal']):
    fitness.append(fitness_evaluation_validation(zdepth, normal,A))
minimum = min(fitness)
index = fitness.index(minimum)
plt.plot(loss_results['test_results'][scena]['antipodes-non-greedy']['zdepth'][index],loss_results['test_results'][scena]['antipodes-non-greedy']['normal'][index],'*', color='red' ,label='antipodes-non-greedy')

fitness=[]
for zdepth, normal in zip(loss_results['test_results'][scena]['antipodes-greedy']['zdepth'],loss_results['test_results'][scena]['antipodes-greedy']['normal']):
    fitness.append(fitness_evaluation_validation(zdepth, normal,A))
minimum = min(fitness)
index = fitness.index(minimum)
plt.plot(loss_results['test_results'][scena]['antipodes-greedy']['zdepth'][index],loss_results['test_results'][scena]['antipodes-greedy']['normal'][index],'*', color='blue' ,label='antipodes-greedy')


fitness=[]
for zdepth, normal in zip(loss_results['test_results'][scena]['POF-based-non-greedy']['zdepth'],loss_results['test_results'][scena]['POF-based-non-greedy']['normal']):
    fitness.append(fitness_evaluation_validation(zdepth, normal,A))
minimum = min(fitness)
index = fitness.index(minimum)
plt.plot(loss_results['test_results'][scena]['POF-based-non-greedy']['zdepth'][index],loss_results['test_results'][scena]['POF-based-non-greedy']['normal'][index],'*', color='green' ,label='POF-based-non-greedy')


fitness=[]
for zdepth, normal in zip(loss_results['test_results'][scena]['POF-based-greedy']['zdepth'],loss_results['test_results'][scena]['POF-based-greedy']['normal']):
    fitness.append(fitness_evaluation_validation(zdepth, normal,A))
minimum = min(fitness)
index = fitness.index(minimum)
plt.plot(loss_results['test_results'][scena]['POF-based-greedy']['zdepth'][index],loss_results['test_results'][scena]['POF-based-greedy']['normal'][index],'*', color='cyan' ,label='POF-based-greedy')
...
plt.savefig("./plots_2/other_papers/best_MAT_all_others_"+scena+args.extension, bbox_inches='tight')
plt.close(1)
