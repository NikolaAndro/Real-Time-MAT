    ...
    def __init__(self,size=1, tasks=None,num_classes=None, ozan=False,half_sized_output=False):
        ...
        if tasks is not None:
            ...
            task_to_params = {
                ...
                'depth_zbuffer'         : {'output_chanels' : 1},
                'edge_occl'    	        : {'output_chanels' : 1},
                'edge_texture'      	: {'output_chanels' : 1},
                'keypoints2d'       	: {'output_chanels' : 1},
                'keypoints3d'       	: {'output_chanels' : 1},
                'normal'            	: {'output_chanels' : 3},
                'principal_curvure' 	: {'output_chanels' : 2},
                'reshading'         	: {'output_chanels' : 1},
                'room_layout'       	: {'output_chanels' : 0, 'num_cla sses':9},
                'segment_uns5d'  	    : {'output_chanels' : 64},
                'segment_und'   	    : {'output_chanels' : 64},
                'segmentsemantic' 	    : {'output_chanels' : 18},
                'vanishing_t'   	    : {'output_chanels' : 0, 'num_cla sses':9}
            }
...
def xception_taskonomy_new(pretrained=False,**kwargs):
    """
    Construct Xception.
    """
